...
export default function Section2() {
  ...
  return (
    ...
    <div style={buttonContainer}>
        ...
        <p style={featuredTextStyle}>This Month</p>
      </div>
      <br />
      <div style={buttonContainer}>
        <h4 style={{ textAlign: "left", fontWeight: "bold", flex: 1 }}>
          Best Selling Products
        </h4>
        <button style={viewButton}>View All</button>
      </div>
      ...
      <MDBRow>
        <MDBCol md="12" lg="3" className="mb-4">
          <MDBCard>
            ...
            <MDBCardImage
              src="images/coat1.png"
              position="top"
              alt="Laptop"
            />
            <MDBCardBody style={cardContentStyle}>
                <div>
                  <p className="lead mb-0" style={{fontWeight:"bold"}}>The North Coat</p>
        ...
        <MDBCol md="12" lg="3" className="mb-4">
          <MDBCard>
            ...
            <MDBCardBody style={cardContentStyle}>
                <div>
                  <p className="lead mb-0" style={{fontWeight:"bold"}}>Gucci duffle bag</p>
                  <div style={pricesContainerStyle}>
        ...
        <MDBCol md="12" lg="3" className="mb-4">
          <MDBCard>
            ...
            <MDBCardBody style={cardContentStyle}>
                <div>
                  <p className="lead mb-0" style={{fontWeight:"bold"}}>RGB liquid Cooler</p>
                  <div style={pricesContainerStyle}>
        ...
        <MDBCol md="12" lg="3" className="mb-4">
          <MDBCard>
            ...
            <MDBCardBody style={cardContentStyle}>
                <div>
                  <p className="lead mb-0" style={{fontWeight:"bold"}}>Small BookShelf</p>
                  <div style={pricesContainerStyle}>
